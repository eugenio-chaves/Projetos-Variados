...
mv ./Models/Covenant/ ./Models/BadApple/
mv ./Components/CovenantUsers/ ./Components/BadAppleUsers/
mv ./Components/Grunts/ ./Components/Scouts/
mv ./Models/Grunts/ ./Models/Scouts/
mv ./Data/Grunt/GruntBridge/ ./Data/Grunt/ScoutBridge/
mv ./Data/Grunt/GruntHTTP/ ./Data/Grunt/ScoutHTTP/
mv ./Data/Grunt/GruntSMB/ ./Data/Grunt/ScoutSMB/
mv ./Components/GruntTaskings/ ./Components/ScoutTaskings/
mv ./Components/GruntTasks/ ./Components/ScoutTasks/
mv ./Data/Grunt/ ./Data/Scout/



find ./ -type f -print0 | xargs -0 sed -i "s/Grunt/Scout/g"
find ./ -type f -print0 | xargs -0 sed -i "s/GRUNT/Scout/g"
find ./ -type f -print0 | xargs -0 sed -i "s/grunt/Scout/g"

#find ./ -type f -print0 | xargs -0 sed -i "s/covenant/BadApple/g"
find ./ -type f -print0 | xargs -0 sed -i "s/Covenant/BadApple/g"
find ./ -type f -print0 | xargs -0 sed -i "s/COVENANT/BadApple/g"
...
find ./ -type f -print0 | xargs -0 sed -i "s/CookieWebClient/ScoutsWebClient/g"
...
find ./ -type f -name "*Grunt*" | while read FILE ; do
	newfile="$(echo ${FILE} |sed -e "s/Grunt/Scout/g")";
	mv "${FILE}" "${newfile}";
done
find ./ -type f -name "*GRUNT*" | while read FILE ; do
	newfile="$(echo ${FILE} |sed -e "s/GRUNT/Scout/g")";
...
find ./ -type f -name "*Covenant*" | while read FILE ; do
	newfile="$(echo ${FILE} |sed -e "s/Covenant/BadApple/g")";
	mv "${FILE}" "${newfile}";
done
...
#find ./ -type f -name "*covenant*" | while read FILE ; do
#	newfile="$(echo ${FILE} |sed -e "s/covenant/Scoutcommand/g")";
#	mv "${FILE}" "${newfile}";
#done
